...
if(trust_health >= 0)
{
	...
	/// @DnDArgument : "caption" ""Trust lvl1: ""
	/// @DnDArgument : "var" "trust_health"
	
	{
		var l5E7BBD3F_0 = x + 10;
		var l5E7BBD3F_1 = y + 20;
		draw_text(l5E7BBD3F_0, l5E7BBD3F_1, string("Trust lvl1: ") + string(trust_health));
	}
...
if(trust_health >= 100)
{
	...
	/// @DnDArgument : "y2" "40"
	/// @DnDArgument : "y2_relative" "1"
	/// @DnDArgument : "value" "trust_health-100"
	/// @DnDArgument : "backcol" "$FFCCCCCC"
	/// @DnDArgument : "barcol" "$FF1A1A1A"
	/// @DnDArgument : "mincol" "$FF0000FF"
	/// @DnDArgument : "maxcol" "$FF00FF00"
	
	{
		...
		draw_healthbar(l6062A8A7_0, l6062A8A7_1, l6062A8A7_2, l6062A8A7_3, trust_health-100, $FFCCCCCC, $FF0000FF, $FF00FF00, 0, (($FFCCCCCC>>24) != 0), (($FF1A1A1A>>24) != 0));
	}
	...
	/// @DnDArgument : "y" "20"
	/// @DnDArgument : "y_relative" "1"
	/// @DnDArgument : "caption" ""Trust lvl2: ""
	/// @DnDArgument : "var" "trust_health"
	
	{
		var l6B740B71_0 = x + 10;
		var l6B740B71_1 = y + 20;
		draw_text(l6B740B71_0, l6B740B71_1, string("Trust lvl2: ") + string(trust_health));
	}
